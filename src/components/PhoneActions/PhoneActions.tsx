...
export const PhoneActions: React.FC<Props> = memo(({ phone, isInCart, isInFavorites }) => {
  ...
  return (
    <div className={s.container}>
      <div className={s.colorsAndIdContainer}>
        ...
        <h3 className={s.subHeading}>{`ID: ${Math.floor(100000 + Math.random() * 900000)}`}</h3>
      </div>
